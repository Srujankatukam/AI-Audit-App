...
2. **Azure OpenAI Resource** - Create in Azure Portal
...
### Step 1: Setup Azure OpenAI (5 minutes)

**Create Azure OpenAI Resource:**
1. Go to https://portal.azure.com
2. Search for "Azure OpenAI" and create new resource
3. Wait for deployment to complete
4. Go to "Model deployments" → Create deployment
5. Choose model (gpt-35-turbo recommended)
6. Go to "Keys and Endpoint" → Copy:
   - Endpoint URL
   - API Key
   - Deployment Name

📘 **Detailed instructions:** See [AZURE_OPENAI_MIGRATION.md](AZURE_OPENAI_MIGRATION.md)
...
### Step 4: Test Azure OpenAI Connection (1 minute)
...
### Step 5: Test Application (30 seconds)
...
# Check Azure Portal for API key validity
```
...
- 🔧 See [AZURE_OPENAI_MIGRATION.md](AZURE_OPENAI_MIGRATION.md) for detailed Azure setup
- 🚀 Check [DEPLOYMENT_GUIDE.md](docs/DEPLOYMENT_GUIDE.md) for production setup
